...
class DataModelNode(BaseModel):
    ...
    data_type: Optional[str] = (
        None  # e.g. "string", "unsignedInt" (only for parameters)
    )
...
class EditMessageRequest(BaseModel):
    ...
    list_instances: Optional[Any] = (
        None  # e.g. list of {"i": "1"} strings or something, let's just make it Any or List[str]
    )
